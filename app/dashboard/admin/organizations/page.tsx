...
export default async function AdminOrganizationsPage() {
  ...
  return <div className="space-y-6">
    <div><p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-600">Pengaturan Organisasi</p>
      <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900">Data Organisasi</h1>
      <p className="mt-2 text-sm text-slate-500">Kelola organisasi dan supervisor di sini. Tetapkan organisasi anggota melalui <Link href="/dashboard/admin/users" className="font-semibold text-emerald-700 underline">Data Pengguna</Link>.</p>
    </div>
