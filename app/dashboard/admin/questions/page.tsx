...
export default async function AdminQuestionsPage() {
  ...
  return <div className="space-y-6">
    <div className="flex items-center gap-4"><div className="rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-4 text-white shadow-lg shadow-emerald-100"><ListChecks size={26}/></div><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-600">Data Master</p><h1 className="mt-1 text-3xl font-black tracking-tight text-slate-900">Manajemen Pertanyaan</h1><p className="mt-1 text-sm text-slate-500">Kelola pertanyaan, opsi jawaban, dan weight 0–2.</p></div></div>
    <QuestionManager
