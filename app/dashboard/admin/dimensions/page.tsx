...
export default async function AdminDimensionsPage() {
  ...
  return <div className="space-y-6">
    <div className="flex items-center gap-4"><div className="rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 p-4 text-white shadow-lg shadow-cyan-100"><Boxes size={26}/></div><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-cyan-600">Data Master</p><h1 className="mt-1 text-3xl font-black tracking-tight text-slate-900">Manajemen Dimensi</h1><p className="mt-1 text-sm text-slate-500">Tambah, lihat, ubah, dan hapus dimensi assessment.</p></div></div>
    <DimensionManager
