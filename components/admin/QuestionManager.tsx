...
const inputClass = "block w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 font-normal outline-none focus:border-emerald-500";
...
export default function QuestionManager({ questions, dimensions }: { questions: Question[]; dimensions: Dimension[] }) {
  ...
  return <div className="space-y-6">
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-5 flex items-center gap-3"><div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700"><Plus size={20}/></div><div><h2 className="font-bold text-slate-900">Tambah Pertanyaan</h2><p className="text-xs text-slate-500">Opsi jawaban dapat ditambahkan setelah pertanyaan tersimpan.</p></div></div>
