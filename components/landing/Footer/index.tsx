...
export default function Footer() {
  return <footer className="bg-[#061221] text-white"><div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
    ...
    <div className="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-3"><div><Image src="/images/logo-sipeta.png" alt="SIPETA POLRI" width={210} height={210} className="h-auto w-44" /><p className="mt-5 max-w-sm leading-7 text-slate-400">Memetakan Kompetensi, Mengarahkan Penempatan.</p></div>
